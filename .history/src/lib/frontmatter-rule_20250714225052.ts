...
const evaluateCriterion = (
  ...
  switch (operator) {
    ...
    case 'not-equals':
      return frontmatterValue !== value;
    case 'greater-than':
      const numFrontmatter1 = typeof frontmatterValue === 'string' ? parseFloat(frontmatterValue) : frontmatterValue;
      const numValue1 = typeof value === 'string' ? parseFloat(value) : value;
      return !isNaN(numFrontmatter1) && !isNaN(numValue1) && numFrontmatter1 > numValue1;
    case 'less-than':
      const numFrontmatter2 = typeof frontmatterValue === 'string' ? parseFloat(frontmatterValue) : frontmatterValue;
      const numValue2 = typeof value === 'string' ? parseFloat(value) : value;
      return !isNaN(numFrontmatter2) && !isNaN(numValue2) && numFrontmatter2 < numValue2;
    case 'greater-equal':
      const numFrontmatter3 = typeof frontmatterValue === 'string' ? parseFloat(frontmatterValue) : frontmatterValue;
      const numValue3 = typeof value === 'string' ? parseFloat(value) : value;
      return !isNaN(numFrontmatter3) && !isNaN(numValue3) && numFrontmatter3 >= numValue3;
    case 'less-equal':
      const numFrontmatter4 = typeof frontmatterValue === 'string' ? parseFloat(frontmatterValue) : frontmatterValue;
      const numValue4 = typeof value === 'string' ? parseFloat(value) : value;
